...
PFTcoverall<-readfiles()
 ...
 makeMeanCover <- function(PFTcoverall) {
  ...
  ## BE CAREFUL WITH RENAMING< AFTER >79 years there might not be all PFTs represented, not sure though if this really is the problem 
  # rename PFTs
...
plot_list$Cattle_very_low_line
...
barplot_list$Wildlife_very_high_bar
...
cattle_low_bar<-ggplot(subset(cover, scenario %in% "Cattle_very_low"),
  ...
  ggsave(cover_legend, file="cover_appendix_65.png", width = 32,
         height = 20,
         units = "cm", dpi=500)
  ...
  #ggsave(cover_legend, file="coverplot_264.tiff",height=5600,width=5200,units="px",res=800,compression="lzw")

  #Tiff(cover_legend, filename="coverplot_264.tif",height=5600,width=5200,units="px",res=800,compression="lzw")
