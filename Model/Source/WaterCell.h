...
class WaterCell{
	...
	public:
        ...
        /***************************************************************************************//**
         *******************************************************************************************/
		WaterCell(int x, int y, double suction, double Ks, double waterL1_sat, double WP, double FC, double depthL1, double depthL2, double iniWaterL0abs, double iniWaterL1,double iniWaterL2, double EPfactor, double resWater, double maxFL2, double maxAmountFL2, double diffConst, double  TE_,
		     int PFTs_, int Perennials_, int Shrubs_, int Annuals_, double Vegcoef1_, double Vegcoef2_, double Veg_ETcoef1_, double Veg_ETcoef2_);  //Constructor has been changed by /*Tong*/
		...
		double K_geom;		                    //!< geometric mean of saturated and unsaturated hydraulic conductivity [mm/h]
		...
		double EPfactor;                    	//!< additional factor to account for e.g. ET reduction by soil crusts etc.
		double resWater;	                    //!< residual soil water content
		double maxFL2;		                    //!< maximal fraction of surface water that infiltrates into lower layer
		double maxAmountFL2;	                //!< maximal total amount of infiltrated water into the lower layer
		double diffConst;	                    //!< diffusion constant that influences the speed of vertical water movement
		double Vegcoef1;                        //!< total vegetation cover coefficient in vegetation function of upper layer for evapotranspiration      /*Tong*/
		double Vegcoef2;                        //!< total vegetation cover coefficient in vegetation function of upper layer for evapotranspiration      /*Tong*/
		double Veg_ETcoef1;                     //!< the transforming coefficient of vegetation cover to evapotranspiration                             /*Tong*/
		double Veg_ETcoef2;                     //!< the transforming coefficient of vegetation cover to evapotranspiration                             /*Tong*/
		...
		double TE;                              //!< TE constant for decreased evapotranspiration at increased CO2 levels
		...
		Double1D PftTL1;                        //!< transpiration of each PFT in the upper layer [mm/d]                            /*Tong*/
		Double1D PftTL2;                        //!< transpiration of each PFT in the lower layer [mm/d]                                     /*Tong*/
		...
		double layerDiff;	                    //!< water that flows from the upper to the lower layer (other way round if negative)
         ...
         *******************************************************************************************/
		void actLayerEvapotranspiration(double rainTot, double potEvapo);
         ...
         * \brief Set PFT cover.
         *******************************************************************************************/
		void setCover(Double1D shrubcover, Double1D grasscover, Double1D annualcover);                   /*Tong*/
        ...
        /***************************************************************************************//**
         * \brief The aspect factor determines how the radiation is affected by the aspect
         * of the slope.
         * The values for this factor were found in
         * Shevenell L., 1999. Regional potental evapotranspiration in arid climates
        ...
        /***************************************************************************************//**
         * \brief calculate total roots in upper and lower soil layer for all PFTs per cell
         *******************************************************************************************/
        void totalRoots();
